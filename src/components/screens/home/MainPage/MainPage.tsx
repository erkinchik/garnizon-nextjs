      ...
      >
        ...
        <div className={classes.div}>
          <h1
            ...
            style={{ fontWeight: "bold", maxWidth: 300, fontSize: 30 }}
          >
            В приложении ещё удобней!
          </h1>
          ...
          <p className={classes.text}>
            <span style={{ fontWeight: "bold" }}>GARNIZON</span> – имеет опыт
            работы по организации охраны бизнес и торговых центров, офисов,
            гостиниц, кафе, складов, закрытых жилых комплексов с 20хх года и
            является ведущим в области организации охраны.
          </p>
        </div>
